...
cred = credentials.Certificate("smart-mirror-ce73a-firebase-adminsdk-rwemu-814d2375a9.json")
...
class Clock(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        # initialize time label
        self.time1 = ''
        self.timeLbl = Label(self, font=('Architects Daughter', large_text_size), fg="blue", bg="black")
        self.timeLbl.pack(side=TOP, anchor=E)
        # initialize day of week
        self.day_of_week1 = ''
        self.dayOWLbl = Label(self, text=self.day_of_week1, font=('Architects Daughter', small_text_size), fg="white", bg="black")
        self.dayOWLbl.pack(side=TOP, anchor=E)
        # initialize date label
        self.date1 = ''
        self.dateLbl = Label(self, text=self.date1, font=('Architects Daughter', small_text_size), fg="white", bg="black")
    ...
    def get_headlines(self):
        try:
            ...
            for widget in self.headlinesContainer.winfo_children():
                widget.destroy()
            if nntype=="Business":
                headlines_url = "https://www.google.com/alerts/feeds/10958476863056604739/4111781624515747515"
            elif nntype=="Technology":
                headlines_url = "https://www.google.com/alerts/feeds/10958476863056604739/14599522074770425645" 
            elif nntype == "Sports" :
                headlines_url= "https://www.google.com/alerts/feeds/10958476863056604739/5427028208460324209"
            elif nntype=="Science":
                headlines_url= "https://www.google.com/alerts/feeds/10958476863056604739/10553007796414762040"
            elif nntype == "Health":
                headlines_url= "https://www.google.com/alerts/feeds/10958476863056604739/1290594813696006804"
            else:
                headlines_url = "https://www.google.com/alerts/feeds/10958476863056604739/10553007796414759481"
...
class FullscreenWindow:
    ...
    def __init__(self):
        ...
        self.todo.pack(side=LEFT, anchor=S, padx=100, pady=60)
